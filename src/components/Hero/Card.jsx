...
import { getLeftCard, getSelectCards } from "../../store/cardSlice";
...
const Card = ({ data }) => {
  ...
  const clickHandler = (id) => {
    ...
    //to add left card number to left card in cardslice file
    dispatch(getLeftCard(leftCard - 1))
  };

  return (
    <div className="flex flex-col items-center relative min-h-[430px] mb-12 fade-in">
      <img
